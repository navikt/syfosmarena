...
internal class ValidationRuleChainTest {
    @Test
    internal fun `Should check rule SICK_LAVE_END_DATE_MORE_THAN_3_MONTHS, should trigger rule`() {
        ...
        assertEquals(
            true,
            ValidationRuleChain.SICK_LAVE_END_DATE_MORE_THAN_3_MONTHS(
                ruleData(
                    healthInformation,
                    metadata,
                ),
    ...
    @Test
    internal fun `Should check rule SICK_LAVE_END_DATE_MORE_THAN_3_MONTHS, should NOT trigger rule`() {
    ...
    @Test
    internal fun `Should check rule SICK_LAVE_PERIODE_MORE_THEN_3_MONTHS, should trigger rule`() {
        fun ruleData(healthInformation: Sykmelding, metadata: RuleMetadata) =
            RuleData(healthInformation, metadata)
        ...
        assertEquals(
            true,
            ValidationRuleChain.SICK_LAVE_PERIODE_MORE_THEN_3_MONTHS(
                ruleData(
                    healthInformation,
                    metadata,
                ),
    ...
    @Test
    internal fun `Should check rule SICK_LAVE_PERIODE_MORE_THEN_3_MONTHS, should NOT trigger rule`() {
        fun ruleData(healthInformation: Sykmelding, metadata: RuleMetadata) =
            RuleData(healthInformation, metadata)
